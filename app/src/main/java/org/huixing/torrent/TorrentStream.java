...
public final class TorrentStream {
     ...
     *
     * @param torrentUrl {@torrentUrl String} URL to .torrent or magnet link
    ...
    private TorrentInfo getTorrentInfo(String torrentUrl) throws TorrentInfoException {
        if (torrentUrl.startsWith("magnet")) {
            ...
            try {
                // 从Github 获得最新的Tracker服务器地址列表 （ https://github.com/ngosang/trackerslist ）
                URL trackerURL = new URL("https://raw.githubusercontent.com/ngosang/trackerslist/master/trackers_all.txt");
                ...
                br.close();
                isr.close();
                byte[] data = d.fetchMagnet(torrentUrl + sb, 30000);
                if (data != null)
     ...
     *
     * @param torrentUrl {@torrentUrl String} .torrent or magnet link
     */
