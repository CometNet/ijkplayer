...
import org.huixing.torrent.listeners.TorrentListener;
...
public class Torrent implements AlertListener {
    ...
    public Torrent(TorrentHandle torrentHandle, TorrentListener listener, Long prepareSize) {
        ...
        if (selectedFileIndex == -1)
            setLargestFile();
        torrentHandle.filePriority(selectedFileIndex,Priority.NORMAL);
    ...
    private void resetPriorities() {
        Priority[] priorities = torrentHandle.filePriorities();
    ...
    public void startDownload() {
        ...
        torrentHandle.piecePriority(selectedFileIndex,Priority.NORMAL);
